...
TreeNode * newStatementNode(StmtKind kind){
    TreeNode * t = (TreeNode *)malloc(sizeof(TreeNode));
    int i=0;
    if(t==NULL)
      std::cout<<"Out of memory error at line "<<lineno<<std::endl;
...
TreeNode * newExpressionNode(TreeNode * first, TreeNode * second, TokenType op){
    TreeNode * t = (TreeNode *)malloc(sizeof(TreeNode));
    int i=0;
    if(t==NULL)
      std::cout<<"Out of memory error at line "<<lineno<<std::endl;
        ...
        switch(tree->nodekind){
            case(NODE_STATEMENT):
                switch(tree->kind.stmt){
                    case STMT_LABEL:
                        std::cout<<"<-Statement label number-> "<<tree->attr.val<<std::endl;
                        break;
                    case STMT_ASSIGN:
                        std::cout<<"<-Statement Assign-> "<<std::endl;
                        break;
                    case STMT_GOTO:
                        std::cout<<"<-goto-> "<<tree->attr.val<<std::endl;
                        break;
                    case STMT_IF:
                    ...
                    case STMT_CASE:
                        ...
                        break;
                    case STMT_FOR:
                        std::cout<<"<-for direction-> "<<std::endl;
                        printToken(tree->attr.op,"\0");
                        break;
                    case STMT_PROC_SYS:
                        std::cout<<"<-system procedure->"<<std::endl;
                        printToken(tree->attr.op,"\0");
                        break;
                    case STMT_PROC_ID:
                        std::cout<<"<-procedure->";
            ...
            case(NODE_EXPRESSION):
               switch(tree->kind.exp){
                    ...
                    case EXP_CONST:
                        switch(tree->type){
                            case EXPTYPE_INT:
                                std::cout<<"[const int] "<<tree->attr.val<<std::endl;
                                break;
                            case EXPTYPE_REAL:
                                std::cout<<"[const real] "<<tree->attr.real_val<<std::endl;
                                break;
                            case EXPTYPE_CHAR:
                                std::cout<<"[const char] "<<tree->attr.char_val<<std::endl;
                                break;
                            case EXPTYPE_STRING:
                                std::cout<<"[const string] "<<tree->attr.string_val<<std::endl;
                                break;
                            default:
                                printf("!!!!error type\n");
                                break;
                        ...
                        break;
                    case EXP_ID:
                       std::cout<<"[Exp ID] "<<tree->attr.name<<std::endl;
                       break;
                    case EXP_CASE:
                       std::cout<<"[Exp case] ";
                       break;
                    case EXP_FUNC_ID:
                       ...
                       break;
                    case EXP_FUNC_SYS:
                       std::cout<<"[System function] ";printToken(tree->attr.op,"\0");
                       break;
                    default:
            ...
            case(NODE_DECLARE):
                switch(tree->kind.decl){
                    case DECL_ROUTINEHEAD:
                        std::cout<<"**Routine Head**"<<std::endl;
                        break;
                    case DECL_PROCEDURE:
                        std::cout<<"**Declare Procedure**"<<std::endl;
                        break;
                    case DECL_PROCEDUREHEAD:
                        std::cout<<"**Procedure Head**"<<tree->attr.name<<std::endl;
                        break;
                    case DECL_CONST:
                        std::cout<<"**Const Declare**"<<std::endl;
                        break;
                    case DECL_TYPE:
                        std::cout<<"**Type Declare**"<<std::endl;
                        break;
                    case DECL_VAR:
                        std::cout<<"**Var Declare**"<<std::endl;
                        break;
                    case DECL_FUNCTION:
                        std::cout<<"**Declare Function**"<<std::endl;
                        break;
                    case DECL_FUNCTIONHEAD:
                        std::cout<<"**Function Head** "<<tree->attr.name<<std::endl;
                        break;
                    case DECL_VAR_PARA:
                        std::cout<<"**var parameter** "<<std::endl;
                        break;
                    case DECL_VAL_PARA:
                        std::cout<<"**val parameters** "<<std::endl;
                        break;
                }
            break;
